...
import { Search, Filter, Edit, Calendar, BookOpen, User, Users, Shield, Clock, MessageCircle, X, Send, RefreshCw } from 'lucide-react';
import {sendMessageAdmin, viewMessageAdmin} from '../../api/userService';

function CommunicationTab({ projectId, currentUserRole, currentUserId }) {
...
//       // Mock API call - replace with actual sendMessage API
